 ...
 * @author M S I
 */
public class StaffViewPackageServlet extends HttpServlet {
...
protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
        ...
        request.setAttribute("error", "Failed to load packages.");
    }

    request.setAttribute("laundryPackages", packages);
    RequestDispatcher dispatcher = request.getRequestDispatcher("staffMenuLaundry.jsp");
